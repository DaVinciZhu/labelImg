...
#>>>>delete(1) from labelDialog import LabelDialog
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    # print FIT_WINDOW,FIT_WIDTH,MANUAL_ZOOM
    ...
    #>>>> delete(2) fileListWidget
        ...
        # Actions,checkedable and enabled are default value respectively
    ...
    #>>>> delete(1)
        ...
        self.actions = struct(save=save,  open=open, close=close,#saveAs=saveAs,
                            #   lineColor=color1, fillColor=color2,
                              create=create, delete=delete, #>>>>delete(1) edit=edit,copy=copy,
                            ...
                            #   shapeLineColor=shapeLineColor, shapeFillColor=shapeFillColor,
                              ...
                              fileMenuActions=(
                                   save,  close, quit),#open, opendir,saveAs,
                              beginner=(), advanced=(),
                            #>>>>delete(1)   editMenu=(edit, copy, delete,
                            #             None, color1, color2),
                              beginnerContext=(create,  delete),#delete(1) edit,copy,
                              advancedContext=(createMode, editMode,   #delete(1)  edit,copy,
                                               delete),#, shapeLineColor, shapeFillColor
                              onLoadActive=(
                                  close, create, createMode, editMode),#delete(1)
        ...
        self.menus = struct(
            ...
            )#>>>> delete(1) labelList=labelMenu

        addActions(self.menus.file,
                   ( changeSavedir, openAnnotation, self.menus.recentFiles, save,  close, None, quit))#saveAs,open, opendir,
        addActions(self.menus.help, (help,))
        addActions(self.menus.view, (
             advancedMode, None,#delete(1) labels,
        ...
        self.actions.beginner = (
             openNextImg, openPrevImg, save, None, create,  delete, None,#copy,open, opendir,
    ...
    def populateModeActions(self):
        ...
        actions = (self.actions.create,) if self.beginner()\
            else (self.actions.createMode, self.actions.editMode)#delete(1)
        #delete(1) addActions(self.menus.edit, actions + self.actions.editMenu)
...
#>>>> delete(2)
    ...
    def shapeSelectionChanged(self, selected=False):
        ...
        #>>>delete(1)s elf.actions.edit.setEnabled(selected)
    ...
    #     #>>>> delete(1) self.labelList.addItem(item)
    ...
    #     #>>>> delete(1)self.labelList.takeItem(self.labelList.row(item))
    #     del self.shapesToItems[shape]
    #     del self.itemsToShapes[item]

    def loadLabels(self, shapes):
        s = []
        for  points, line_color, fill_color in shapes:#delete(3) label,
            shape = Shape()#delete(3) label=label
            for x, y in points:
                shape.addPoint(QPointF(x, y))
            shape.close()
            s.append(shape)
            #delete(3) self.addLabel(shape)
            if line_color:
    ...
    def saveLabels(self, annotationFilePath):
        ...
        def format_shape(s):
            return dict(
                        ...
                        points=[(p.x(), p.y()) for p in s.points])#>>>delete(3) label=s.label,
...
#>>>> delete(1)
    ...
    def openDir(self, _value=False):
        ...
        dirpath = path#u(QFileDialog.getExistingDirectory(self,
    ...
    def openNextImg(self, _value=False):
        ...
        if self.filePath is None:
            ...
            if self._first_:
                ...
                filename = self.mImgList[currIndex + 1]
        # print 'currFile:',filename,'---',self.filePath
        if filename:
            self.loadFile(filename)
        else:
            button=QMessageBox.warning(self,"Warning",
